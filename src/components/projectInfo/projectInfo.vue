...
<div>
	<el-form ref="checkForm" :model="projectForm" :rules="rules" label-width="180px">
    	...
    	<el-row :span="8">
    				<el-form-item prop="projectStartTime" label="项目起止时间" label-width="200px">
						<el-date-picker
    				...
    				<el-form-item prop="landUseRightStart" label="取得土地使用权" label-width="200px">
						<el-date-picker
    				...
    				label="建设用地规划许可证" label-width="200px">
						<el-date-picker
					    ...
					    <el-form-item prop="engineeringLicenseStart" label="建设工程规划许可证" label-width="200px">
								<el-date-picker
    				 ...
    				 <el-form-item prop="tenderStart" label="施工图设计及审查" label-width="200px">
						<el-date-picker
    				...
    				<el-form-item prop="comprehensiveInspectionAndAcceptanceStart" label="组织工程招标及工程施工"
			    label-width="200px">
						<el-date-picker
					    ...
					    <el-date-picker
    					 ...
    					 <el-form-item prop="deliveryStart" label="项目综合验收"
			    label-width="200px">
					<el-date-picker
    				...
    				<el-form-item prop="constructionDrawingStart" label="项目交付使用"
			    label-width="200px">
						<el-date-picker
    	...
    	<el-row>
    		<label>项目产业化信息</label>
    			...
    			<el-input v-model="projectForm.projectIndustrialization.industrializedTechnologyArea" style="width:500px"><template slot="append">%</template></el-input>
			    </el-form-item>
			    <el-form-item label="落实产业化技术的面积比例" prop="industrializedTechnologyAreaRatio">
			    <el-input v-model="projectForm.projectIndustrialization.industrializedTechnologyAreaRatio" style="width:500px"><template slot="append">%</template></el-input>
			    </el-form-item>
			    <el-form-item label="建筑单体装配率（≥45%）"prop="unitAssemblyRate">
			    <el-input v-model="projectForm.projectIndustrialization.unitAssemblyRate"style="width:500px"><template slot="append">%</template></el-input>
			    </el-form-item>
			    <el-form-item label="建筑外墙采用预制墙体的比例（≥60%）"prop="wall">
			    <el-input v-model="projectForm.projectIndustrialization.wall"style="width:420px"><template slot="append">%</template></el-input>
			    </el-form-item>
			    <el-form-item label="各单体预制外墙水平投影总面积" prop="wallShadowArea">
			    <el-input v-model="projectForm.projectIndustrialization.wallShadowArea" style="width:480px"><template slot="append">万平方米</template></el-input>
			    </el-form-item> 
			    <el-form-item label="不纳入地上容积率的建筑面积" prop="constructionArea">
			    <el-input v-model="projectForm.projectIndustrialization.constructionArea" style="width:500px"><template slot="append">万平方米</template></el-input>
			    </el-form-item> 
			    <el-form-item>
				    <el-row>
				    <el-col :span="6">
