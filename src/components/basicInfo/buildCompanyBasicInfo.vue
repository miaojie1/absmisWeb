<template>
<div>
    <el-form :model="buildInformation" label-width="180px" :rules="rules" ref="buildInformation" :inline="true">
        ...
        <el-form-item label="资质等级" prop="builderQualificationId" label-width="180px">
            <el-select v-model="builderQualificationId" placeholder="请选择" class="put">
                <el-option
