<template>
    <div>
        ...
        @current-change="handleCurrentChange">
            ...
            <el-table-column label="填报时间" align="center" prop="declareTime" > 
            </el-table-column>
            <el-table-column label="预制混凝土生产设备数量" align="center" prop="integralWall" > 
            </el-table-column>
            <el-table-column label="专用运输设备数量" align="center" prop="specialTransportEquipment" > 
            </el-table-column>
            <el-table-column label="专用施工设备数量" align="center" prop="specialConstructionEquipment" > 
            </el-table-column>
        </el-table>
            <el-pagination
