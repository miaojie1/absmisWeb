...
<el-form ref="form" :model="projectForm" label-width="180px">
    	...
    	<el-row :span="8">
				<el-form-item label="项目起止时间" label-width="200px">
			    <!--<el-row :span="20">-->
				<el-date-picker
			    ...
			    <el-form-item label="取得土地使用权" label-width="200px">
			    <!--<el-row :span="20">-->
				<el-date-picker
			    ...
			    <el-form-item label="建设用地规划许可证" label-width="200px">
			    <!--<el-row :span="20">-->
				<el-date-picker
			    ...
			    <el-form-item label="建设工程规划许可证" label-width="200px">
			    <!--<el-row :span="20">-->
				<el-date-picker
			    ...
			    <el-form-item label="施工图设计及审查" label-width="200px">
			    <!--<el-row :span="20">-->
				<el-date-picker
