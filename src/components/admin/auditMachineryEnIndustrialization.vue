        ...
        <el-row>
            <el-col>
                ...
                @current-change="handleSelectionChange">
                    ...
                    <el-table-column label="企业名称" prop="machineryEn.name" align="center"> 
                    </el-table-column>
                    <el-table-column label="填报时间" prop="declareTime" align="center"> 
                    </el-table-column>
                    <el-table-column label="新增预制混凝土生产设备的数量" prop="integralWall" align="center"> 
                    </el-table-column>
                    <el-table-column label="新增专用运输设备的数量" prop="specialTransportEquipment" align="center"> 
                    </el-table-column>
                    <el-table-column label="新增专用施工设备的数量" prop="specialConstructionEquipment" align="center"> 
                    </el-table-column>
                    <el-table-column label="审核状态" prop="checkedStatus.state" align="center"> 
                    </el-table-column>
                </el-table>
            </el-col>
        </el-row>
